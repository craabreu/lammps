...
#ifndef LMP_FIX_NH_REGULATED_H
#define LMP_FIX_NH_REGULATED_H

#include "fix.h"    // IWYU pragma: export

namespace LAMMPS_NS {

class FixNHRegulated : public Fix {
 public:
  FixNHRegulated(class LAMMPS *, int, char **);
  virtual ~FixNHRegulated();
  int setmask();
  virtual void init();
 ...
 protected:
  ...
  double boltz, nktv2p, mvv2e, tdof;
