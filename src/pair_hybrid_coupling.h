...
PairStyle(hybrid/coupling,PairHybridCoupling)

#else

#ifndef LMP_PAIR_HYBRID_COUPLING_H
#define LMP_PAIR_HYBRID_COUPLING_H
...
class PairHybridCoupling : public Pair {
  friend class FixGPU;
 ...
 public:
  PairHybridCoupling(class LAMMPS *);
  virtual ~PairHybridCoupling();
