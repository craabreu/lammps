...
#ifndef LMP_FIX_NH_MASSIVE_MOLECULAR_H
#define LMP_FIX_NH_MASSIVE_MOLECULAR_H

#include "fix.h"    // IWYU pragma: export

namespace LAMMPS_NS {

class FixNHMassiveMolecular : public Fix {
 public:
  FixNHMassiveMolecular(class LAMMPS *, int, char **);
  virtual ~FixNHMassiveMolecular();
  int setmask();
  virtual void init();
 ...
 protected:
  ...
  void nhc_press_integrate(double);
