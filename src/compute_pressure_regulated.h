...
#ifdef COMPUTE_CLASS
// clang-format off
ComputeStyle(pressure/regulated,ComputePressureRegulated);
// clang-format on
#else

#ifndef LMP_COMPUTE_PRESSURE_REGULATED_H
#define LMP_COMPUTE_PRESSURE_REGULATED_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputePressureRegulated : public Compute {
 public:
  ComputePressureRegulated(class LAMMPS *, int, char **);
  virtual ~ComputePressureRegulated();
  virtual void init();
  virtual void setup();
