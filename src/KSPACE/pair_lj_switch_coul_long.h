...
PairStyle(lj/switch/coul/long,PairLJSwitchCoulLong)

#else

#ifndef LMP_PAIR_LJ_SWITCH_COUL_LONG_H
#define LMP_PAIR_LJ_SWITCH_COUL_LONG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJSwitchCoulLong : public Pair {
 public:
  PairLJSwitchCoulLong(class LAMMPS *);
  virtual ~PairLJSwitchCoulLong();
...
E: Pair style lj/switch/coul/long requires atom attribute q
