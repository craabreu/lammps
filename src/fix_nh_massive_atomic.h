...
#ifndef LMP_FIX_NH_MASSIVE_ATOMIC_H
#define LMP_FIX_NH_MASSIVE_ATOMIC_H

#include "fix.h"    // IWYU pragma: export

namespace LAMMPS_NS {

class FixNHMassiveAtomic : public Fix {
 public:
  FixNHMassiveAtomic(class LAMMPS *, int, char **);
  virtual ~FixNHMassiveAtomic();
  int setmask();
  virtual void init();
